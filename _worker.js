...
// Variables
const rootDomain = "voc6000.workers.dev"; // Ganti dengan domain utama kalian
const serviceName = "qzer"; // Ganti dengan nama workers kalian
...
function getAllConfig(request, hostName, proxyList, page = 0) {
  ...
  try {
    ...
    document.setTitle("Welcome to <span class='text-blue-500 font-semibold'>crown.rf.gd</span>");
